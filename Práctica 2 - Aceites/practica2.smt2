...
(assert (<= (+ (ite (> refinado_0_4 0 ) 1 0 ) (+ (ite (> refinado_0_3 0 ) 1 0 ) (+ (ite (> refinado_0_2 0 ) 1 0 ) (+ (ite (> refinado_0_1 0 ) 1 0 ) (ite (> refinado_0_0 0 ) 1 0 ) ) ) ) ) 2 ) )
(assert (<= (+ (ite (> refinado_1_4 0 ) 1 0 ) (+ (ite (> refinado_1_3 0 ) 1 0 ) (+ (ite (> refinado_1_2 0 ) 1 0 ) (+ (ite (> refinado_1_1 0 ) 1 0 ) (ite (> refinado_1_0 0 ) 1 0 ) ) ) ) ) 2 ) )
(assert (<= (+ (ite (> refinado_2_4 0 ) 1 0 ) (+ (ite (> refinado_2_3 0 ) 1 0 ) (+ (ite (> refinado_2_2 0 ) 1 0 ) (+ (ite (> refinado_2_1 0 ) 1 0 ) (ite (> refinado_2_0 0 ) 1 0 ) ) ) ) ) 2 ) )
(assert (<= (+ (ite (> refinado_3_4 0 ) 1 0 ) (+ (ite (> refinado_3_3 0 ) 1 0 ) (+ (ite (> refinado_3_2 0 ) 1 0 ) (+ (ite (> refinado_3_1 0 ) 1 0 ) (ite (> refinado_3_0 0 ) 1 0 ) ) ) ) ) 2 ) )
(assert (<= (+ (ite (> refinado_4_4 0 ) 1 0 ) (+ (ite (> refinado_4_3 0 ) 1 0 ) (+ (ite (> refinado_4_2 0 ) 1 0 ) (+ (ite (> refinado_4_1 0 ) 1 0 ) (ite (> refinado_4_0 0 ) 1 0 ) ) ) ) ) 2 ) )
(assert (<= (+ (ite (> refinado_5_4 0 ) 1 0 ) (+ (ite (> refinado_5_3 0 ) 1 0 ) (+ (ite (> refinado_5_2 0 ) 1 0 ) (+ (ite (> refinado_5_1 0 ) 1 0 ) (ite (> refinado_5_0 0 ) 1 0 ) ) ) ) ) 2 ) )
(maximize beneficio )
(check-sat)
(get-value (beneficio) )
